...
<div class="contact-success">
  <div class="contact-success__card">
    ...
    <div class="contact-success__content">
      <h1 class="contact-success__title">{{ i18n "formSuccessTitle" | default "MESSAGE ENVOYÉ!" }}</h1>
      <div class="contact-success__divider"></div>
      <p class="contact-success__message">{{ i18n "formSuccessMessage" | default "Merci pour votre message. Je répondrai dès que possible." }}</p>
    </div>
    ...
    <div class="contact-success__languages">
      ...
      <span class="contact-success__lang active">FR</span>
    </div>
    ...
    <div class="contact-success__action">
      <a href="{{ "/" | relLangURL }}" class="contact-success__button">
        ...
        {{ i18n "backToPortfolio" | default "Retour au portfolio" }}
      </a>
    </div>
  </div>
  ...
  <div class="contact-success__details">
    <div class="contact-success__status">
      <span class="contact-success__status-label">{{ i18n "status" | default "Statut" }}</span>
      <div class="contact-success__status-indicator">
        <div class="contact-success__status-dot"></div>
        <span class="contact-success__status-text">{{ i18n "encryptionActive" | default "Chiffrement actif" }}</span>
      </div>
    </div>
